      ...
      {heroWorkout && (
        <section className="space-y-3">
          <button
            ...
            className={`w-full ${
              activeWorkout ? "bg-[#32D74B] animate-pulse" : "bg-[#FF9500]"
            } p-6 rounded-[2.5rem] flex flex-col items-start justify-between shadow-xl shadow-orange-950/30 active:scale-[0.97] transition-all relative overflow-hidden group`}
          >
            ...
            <div
              className={`relative z-10 mt-6 flex items-center space-x-2 bg-black ${
                activeWorkout ? "text-[#32D74B]" : "text-[#FF9500]"
              } px-4 py-2 rounded-full text-xs font-black uppercase tracking-widest`}
            >
              <i
                className={`fa-solid ${
                  activeWorkout ? "fa-arrow-right" : "fa-play"
                } text-[8px]`}
              ></i>
